...
Supports:
- Crypto exchanges: Binance, OKX, Bitget, Bybit, Coinbase, Kraken, KuCoin, Gate, Deepcoin, HTX, MEXC
...
def create_client(exchange_config: Dict[str, Any], *, market_type: str = "swap") -> BaseRestClient:
    ...
    if exchange_id == "mexc":
        default_mexc = "https://api.mexc.com"
        base_url = _get(exchange_config, "base_url", "baseUrl") or default_mexc
        return MexcClient(
            api_key=api_key,
            secret_key=secret_key,
            passphrase=passphrase,
